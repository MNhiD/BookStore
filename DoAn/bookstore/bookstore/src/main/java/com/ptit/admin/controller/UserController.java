	...
	public String updateUser(@ModelAttribute("user") User user, 
		...
		if(!user2.isPresent()) {
			...
			if(existUsername || existPhone || existEmail) {
				...
				ra.addFlashAttribute("erorrMes", MessageNotify.USER_SAVE_FAILED);
				return "redirect:/admin/customer";
				...
				ra.addFlashAttribute("successMes", MessageNotify.USER_SAVE_SUCCESS);// trạng thái lỗi
			}
			...
			if(existPhone || existEmail) {
				...
				ra.addFlashAttribute("erorrMes", MessageNotify.USER_EDIT_FAILED);
				return "redirect:/admin/customer";
			}else {
...
//				user.setPassword(passwordConvert);
				...
				ra.addFlashAttribute("successMes", MessageNotify.USER_EDIT_SUCCESS);
			}
...
//		ra.addFlashAttribute("address2", list);
	...
	public String updateUser(
		...
		if(status==0) ra.addFlashAttribute("erorrMes", MessageNotify.USER_DEL_FAILED);
		else ra.addFlashAttribute("successMes", MessageNotify.USER_DEL_SUCCESS);
